...
const approveEmployee = async (employee) => {
  ...
  const employeeNumber = String(employee.id).padStart(3, "0");

  const newEmployeeId = "EMP" + employeeNumber;
  ...
  const { error } = await supabase
    ...
    .update({
      ...
      status: "active",
      role: employee.requested_role || "worker",
    })
    .eq("id", employee.id);
          ...
          {employees.map((employee) => (
            ...
            >
              ...
              <div className="mt-4 space-y-2 text-white/60">
                ...
                <div>
                  Requested Role: {employee.requested_role}
                </div>

                <div>
                  Temporary ID: {employee.employee_id}
                </div>
